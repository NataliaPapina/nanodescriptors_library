...
builder = DescriptorDatasetBuilder(dataframe=my_df, formula_col="Metal oxides")
result = builder.build()
result.to_csv('df_ds1.csv', index=False)
...
clean_df.to_csv('clean_df_ds1.csv', index=False)