...
clean_df = pd.read_csv(r'C:\Users\Public\Documents\nanomaterials_descriptors_library\tests\preprocess_test\clean_df_nz_Vmax_only_lb.csv')
X = clean_df.drop(columns=["Vmax, mM/s", 'formula'])
y = clean_df["Vmax, mM/s"].apply(lambda x: np.log10(x+1))
